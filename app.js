...
async function loadBootData(){
  ...
  try{
    const [rr,pr,fr]=await Promise.all([fetch("data/roster.json?v=0.6.4",{cache:"no-store"}),fetch("data/portraits.json?v=0.6.4",{cache:"no-store"}),fetch("data/form-portraits.json?v=0.6.4",{cache:"no-store"})]);
